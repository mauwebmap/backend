...
def upgrade() -> None:
    ...
    sa.Column('from_outdoor_id', sa.Integer(), nullable=True),
    sa.Column('to_outdoor_id', sa.Integer(), nullable=True),
    sa.Column('from_floor_id', sa.Integer(), nullable=True),
    sa.Column('to_floor_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['from_floor_id'], ['floors.id'], ),
    sa.ForeignKeyConstraint(['from_outdoor_id'], ['outdoor_segments.id'], ),
    sa.ForeignKeyConstraint(['from_segment_id'], ['segments.id'], ),
    sa.ForeignKeyConstraint(['room_id'], ['rooms.id'], ),
    sa.ForeignKeyConstraint(['segment_id'], ['segments.id'], ),
    sa.ForeignKeyConstraint(['to_floor_id'], ['floors.id'], ),
    sa.ForeignKeyConstraint(['to_outdoor_id'], ['outdoor_segments.id'], ),
